 ...
 */
final class Version20181115111839 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message_topic (id INT AUTO_INCREMENT NOT NULL, from_user_id INT NOT NULL, to_user_id INT NOT NULL, title VARCHAR(255) NOT NULL, send_at DATETIME NOT NULL, readed_from_user TINYINT(1) NOT NULL, readed_to_user TINYINT(1) NOT NULL, INDEX IDX_62E621F02130303A (from_user_id), INDEX IDX_62E621F029F6EE60 (to_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
